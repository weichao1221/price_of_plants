...
#     except:
#         username = 'Guest'
#     global function_dir, project_dir
...
#     data_path = os.path.join(os.path.dirname(__file__), "user_folder", f'{username}', "progress_reports_xd")
...
#     print('开始处理连接上期数据')
#     project_last_dir = os.path.join(os.path.dirname(__file__), "user_folder", f'{username}', "progress_reports_xd", Contract_Name,
...
#     print(year, month, Contract_Name, Reporting_Periods)
#     function_dir = os.path.join(os.path.dirname(__file__), 'user_folder', f'{username}')
#     project_info_xlsx_dir = os.path.join(function_dir, "progress_reports_xd")
#     project_dir = os.path.join(os.path.dirname(__file__), "user_folder", f'{username}',
#                                "progress_reports_xd", Contract_Name, f'第{Reporting_Periods}期')
#     output_folder_path = creat_folder(os.path.join(project_dir, "output_files"))  # 输出文件路径
#
